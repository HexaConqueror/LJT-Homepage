...
* **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (Arxiv, 2025)
  <br>Junteng Liu (first author), Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He
* **On the Perception Bottleneck of VLMs for Chart Understanding** (Arxiv, 2025)
  <br>Junteng Liu (first author), Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He
* **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024)
  <br>Junteng Liu (first author), Shiqi Chen, Yu Cheng, Junxian He
